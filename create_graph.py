...
try:
    fig, axes = plt.subplots(2, 2, figsize=(15, 12))  # Increase the size of the subplots
    ...
    if df3 is not None:
        ...
        axes[1, 0].pie(df3['NumberOfProductsSupplied'], labels=df3['SupplierName'], autopct='%1.1f%%', startangle=80)
        axes[1, 0].set_title('Distribution of Products Supplied by Suppliers',fontsize=14)
